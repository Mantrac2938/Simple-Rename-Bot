...
async def start_cmd(bot, msg):
    ...
    btn = InlineKeyboardMarkup([[
        InlineKeyboardButton("🤖 SOURCE CODE", url="https://t.me/Cinema_Adholokam_12k23")
        ],[
        InlineKeyboardButton("🖥️ How To Deploy", url="https://t.me/Cinema_Adholokam_12k23")
    ]])
...
async def start(bot, msg, cb=True):   
    ...
    button= [[
        InlineKeyboardButton("🤖 Bot Updates", url="https://t.me/Cinema_Adholokam_12k23")
        ],[
...
async def about(bot, msg):
    me=await bot.get_me()
    Master=f"<a href=https://t.me/Cinema_Adholokam_12k23>harisir</a> & <a href=https://t.me/Cinema_Adholokam_12k23>hari</a>"  
    Source="<a href=https://github.com/MrMKN/Simple-Rename-Bot>Click Here</a>"
    txt=f"<b>Bot Name: {me.mention}\nDeveloper: <a href=https://github.com/MrMKN>MrMKN</a>\nBot Updates: <a href=https://t.me/Cinema_Adholokam_12k23>Mᴋɴ Bᴏᴛᴢ™</a>\nMy Master's: {Master}\nSource Code: {Source}</b>"                 
    button= [[        
        InlineKeyboardButton("🚫 Close", callback_data="del"),
        InlineKeyboardButton("⬅️ Back", callback_data="start") 
    ]]  
